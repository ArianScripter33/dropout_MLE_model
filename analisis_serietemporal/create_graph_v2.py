...
line1 = ax1.plot(matricula_df.index, matricula_df['m_licenciatura'], color=color, label='Matrícula Total')
...
line2 = ax2.plot(egresados_df.index, egresados_df['egresados_acumulados'], color='tab:green', label='Egresados (Acumulado)')
line3 = ax2.plot(titulados_df.index, titulados_df['titulados_acumulados'], color='tab:purple', label='Titulados (Acumulado)')
line4 = ax2.plot(bajas_df.index, bajas_df['bajas'], color='tab:orange', label='Bajas (Por Trimestre)')
ax2.tick_params(axis='y', labelcolor=color)
ax2.yaxis.set_major_formatter(mticker.StrMethodFormatter('{x:,.0f}'))


# Add title and legend
fig.suptitle('Serie Temporal de Indicadores Clave en la UNRC (2021-2025)', fontsize=16)
...
# Save the figure
plt.savefig('exhibit_3_serie_temporal_v2.png')

print("Graph saved as exhibit_3_serie_temporal_v2.png")
